...
import { Calendar, Trophy, ExternalLink, Clock, CheckCircle } from 'lucide-react'
    ...
    <div className="card-hover bg-[#1e293b] rounded-xl overflow-hidden">
      ...
      <div className="p-6">
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          <span
            className="shrink-0 inline-flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-full font-medium"
            style={{
            ...
            {submitted ? (
              ...
              <>
                <textarea
                  ...
                  className="w-full bg-[#020617] border border-white/10 rounded-lg p-3 text-sm text-white resize-none focus:border-[#00ff9c]/30"
                  rows={3}
                />
                <button
                  onClick={submitFeedback}
                  className="mt-2 text-sm px-4 py-2 rounded-lg bg-[#00ff9c]/20 text-[#00ff9c] hover:bg-[#00ff9c]/30 transition-all"
                >
                  Submit
                </button>
              </>
  ...
  return (
    <div className="pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* TABS */}
        <div
          className="flex flex-wrap gap-2 mb-8 p-1 rounded-xl w-fit mx-auto"
          style={{
            background: '#1e293b',
          ...
          {tabs.map(({ key, label, color, count }) => (
            ...
            >
              ...
              <span
                ...
                style={{
                  background: tab === key ? `${color}25` : '#ffffff10',
